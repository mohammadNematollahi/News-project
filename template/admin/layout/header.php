...
<head>
    ...
    <link href="<?= asset('/asset/adminpanel/css/style.css') ?>" rel="stylesheet" type="text/css">
    <link href="<?= asset('/asset/adminpanel/css/bootstrap.min.css') ?>" rel="stylesheet" type="text/css">
    <link href="<?= asset('/asset/jalalidatepicker/persian-datepicker.min.css') ?>" rel="stylesheet" type="text/css">
    <link href="<?= asset('/asset/jalalidatepicker/persian-datepicker.min.css.map') ?>" rel="stylesheet" type="text/css">
    ...
    <div class="container-fluid">
        <div class="row">
            <nav class="col-md-2 d-none d-md-block pt-3 bg-sidebar sidebar px-0">
                <a class="text-decoration-none d-block py-1 px-2 mt-1" href="<?= url("admin/show") ?>"><i class="fas fa-home"></i> Home</a>
                ...
                <a class="text-decoration-none d-block py-1 px-2 mt-1" href="<?= url("admin/baner") ?>"><i class="fas fa-image"></i> Banner</a>
