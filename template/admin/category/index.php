        ...
        <tbody>
            ...
            foreach ($categories as $result) { ?>
                <tr>
                    ...
                    <td>
                        <a role="button" href="<?= url("admin/category/edit/{$result->id}") ?>" class="btn btn-sm btn-info my-0 mx-1 text-white">update</a>
                        <a role="button" href="<?= url("admin/category/ditroy/{$result->id}") ?>" class="btn btn-sm btn-danger my-0 mx-1 text-white">delete</a>
                    </td>
                </tr>
            <?
                $id++;
