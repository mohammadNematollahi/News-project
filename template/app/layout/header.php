...
<head>
    ...
    <!--
		CSS
		============================================= -->
    <link rel="stylesheet" href="<?= url("/asset/app/css/linearicons.css") ?>">
    <link rel="stylesheet" href="<?= url("/asset/app/css/font-awesome.min.css") ?>">
    <link rel="stylesheet" href="<?= url("/asset/app/css/bootstrap.css") ?>">
    <link rel="stylesheet" href="<?= url("/asset/app/css/magnific-popup.css") ?>">
    <link rel="stylesheet" href="<?= url("/asset/app/css/nice-select.css") ?>">
    <link rel="stylesheet" href="c<?= url("/asset/app/css/animate.min.css") ?> ">
    <link rel="stylesheet" href="<?= url("/asset/app/css/owl.carousel.css") ?>">
    <link rel="stylesheet" href="<?= url("/asset/app/css/jquery-ui.css") ?>">
                ...
                <nav id="nav-menu-container">
                    <ul class="nav-menu">
                        ...
                        foreach ($menus as $menu) { ?>
                            <li class="menu-active"><a href="index.html"><?= $menu->name ?></a></li>
                        <? }
                        ?>
                    </ul>
                </nav>
